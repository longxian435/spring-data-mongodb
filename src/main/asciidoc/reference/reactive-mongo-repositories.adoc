...
Reactive Repositories do not support Geospatial Queries and Type-safe Query methods using QueryDSL.
...
public interface PersonRepository<Person, String> {
